 ...
 * kr.co.shineware.ds.trie.trie.doublearray.ahocorasick.AhoCorasickDoubleArrayTrie Project
...
public class AhoCorasickDoubleArrayTrie<V> implements Serializable {
    ...
    private void storeEmits(int position, int currentState, List<Hit<V>> collectedEmits) {
        ...
        if (hitArray != null) {
            for (int hit : hitArray) {
                if (position == -1) {
                    collectedEmits.add(new Hit<>(v[hit]));
                } else {
    ...
    private void storeEmits(int currentState, List<Hit<V>> collectedEmits) {
        this.storeEmits(-1, currentState, collectedEmits);
    }
    ...
    /**
     * Build a kr.co.shineware.ds.trie.trie.doublearray.ahocorasick.AhoCorasickDoubleArrayTrie from a map
     *
...
//    }
    ...
    /**
     * A builder to build the kr.co.shineware.ds.trie.trie.doublearray.ahocorasick.AhoCorasickDoubleArrayTrie
     */
